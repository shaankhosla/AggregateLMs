...
{MODEL_NAME} (string) - gpt2, distilgpt2, gpt2-medium, gpt2-large, gpt2-xl

Run command:
python /scratch/${USER}/AggregateLMs/model_gpt2/train_models_variance.py -d /scratch/${USER}/superglue/{TASK_NAME}  -o /scratch/${USER}/saved_models/model_checkpoints -s /scratch/${USER}/saved_models/models -m {MODEL_NAME}  -n 10
...
f = open("/scratch/pfi203/AggregateLMs/hyperparams.json")
    ...
    for i in range(10):
        ...
        for j in range(5):
            ...
            training_args = TrainingArguments(
                ...
                gradient_accumulation_steps=int(hyperparams['gradient_accumulation_steps_']),
